...
public class HotelSecondListAdapter extends BaseAdapter{
    ...
    private int[] arrImages = new int[]{R.mipmap.icon_hotel_b_a,R.mipmap.icon_hotel_b_b,R.mipmap.icon_hotel_b_c,R.mipmap.icon_hotel_b_d
            , R.mipmap.icon_hotel_b_e};


    private RequestQueue queue;
    private ImageLoader imageLoader;
    public HotelSecondListAdapter(Context context, RequestQueue queue){

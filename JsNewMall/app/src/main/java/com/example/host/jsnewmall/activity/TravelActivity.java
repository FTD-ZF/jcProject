...
public class TravelActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView mImgCall,mImgMessage;
    ...
    private void getIntentData(){
        ...
        currentpage=intent.getIntExtra("currentindex",0);
...
//        barText = (TextView) findViewById(R.id.cursoraa);// 动画效果的线
        ...
        mTvTravela =(TextView)findViewById(R.id.travel_content_a);//周边游改为巴士游
        ...
        mSearchview=(LinearLayout)findViewById(R.id.tv_search_address);//跳转搜索页面
        mImgCall=(ImageView)findViewById(R.id.img_title_call);//打电话
        mImgMessage=(ImageView)findViewById(R.id.img_title_message);//消息
...
//        mTvTravela.setTextColor(getResources().getColor(R.color.title_orange));
        ...
        if (currentpage==0){
            ...
            mPager.setCurrentItem(3);// 设置当前显示标签页为第一页
    ...
    public void onClick(View view) {
         switch (view.getId()){
             ...
             case R.id.tv_search_address:
                 Intent intentresult=new Intent(TravelActivity.this,SearchActivity.class);
                 startActivity(intentresult);
                 finish();
                 break;
             //打电话
             case R.id.img_title_call:
                 DialogCallPhone.showdialog(TravelActivity.this);

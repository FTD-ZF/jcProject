...
public class PopForthAdapter extends BaseAdapter {

    private SearchkeywordEntry mBodyinfo;
    private Context mContext;
    private int mSelect=0;

    public PopForthAdapter(Context context, SearchkeywordEntry info) {
        this.mBodyinfo = info;
    ...
    @Override
    public int getCount() {
        return mBodyinfo.getGotrafficdata().size();
    }

    @Override
    public Object getItem(int position) {
        return mBodyinfo.getGotrafficdata().get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
       Holder holder;
        ...
        holder.tvname.setText(mBodyinfo.getGotrafficdata().get(position).getAttrdetailname());

...
public class DashedLineView extends View {
    ...
    public DashedLineView(Context context, AttributeSet attrs) {
        ...
        lineHeight = typedArray.getDimension(R.styleable.DashedLineView_lineHeight, DEFAULT_LINE_HEIGHT);
        lineWidth = typedArray.getDimension(R.styleable.DashedLineView_lineWidth, DEFAULT_LINE_WIDTH);
        lineColor = typedArray.getColor(R.styleable.DashedLineView_lineColor, DEFAULT_LINE_COLOR);

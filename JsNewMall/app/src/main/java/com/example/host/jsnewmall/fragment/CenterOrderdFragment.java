...
import com.example.host.jsnewmall.adapter.CenterOrderdAdapter;
...
public class CenterOrderdFragment extends BaseFragment {
    private View view;
    ...
    private CenterOrderdEntry mOrderaInfo;
    private PullableListView mListview;
    private int currentpage=1;
    private CenterOrderdAdapter adaptera;
    private List<CenterOrderdEntry.OrderlistBean> mBodyListaa;
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case FINISH_CODE:
                    dialog.dismiss();
                    List<CenterOrderdEntry.OrderlistBean> mBodyList = mOrderaInfo.getOrderlist();
                    ...
                    if (adaptera==null) {
                        adaptera = new CenterOrderdAdapter(getActivity(), mBodyListaa);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_center_order_d_content,null);
        dialog=new LoadingDialog(getActivity());
        dialog.show();
        Date d=new Date();
        mSimpleTime=new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
        nTime=mSimpleTime.format(d);
        mBodyListaa = new ArrayList<CenterOrderdEntry.OrderlistBean>();
    ...
    private void initView(){
        mPullLayout=(PullToRefreshLayout)view.findViewById(R.id.refresh_view_orderd);//布局刷新监听
        mListview=(PullableListView)view.findViewById(R.id.content_view_d);//listview
    }
    ...
    protected  void dohttpOrderaInfo(String url,JSONObject  paramhash){
        HttpUtils.dopost(url,getActivity(),paramhash, new HttpUtils.CallBack() {
            ...
            public void onRequestComplete(String result) {
                ...
                mOrderaInfo=gson.fromJson(body, CenterOrderdEntry.class);

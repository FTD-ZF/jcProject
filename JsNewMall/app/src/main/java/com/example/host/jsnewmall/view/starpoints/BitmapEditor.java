...
public class BitmapEditor {
    ...
    public BitmapEditor(BitmapAttrs attrs) {
        mAttrs = attrs;
        mOutputBm = Bitmap.createBitmap(mAttrs.getTargetWidth(), mAttrs.getTargetHeight(), Bitmap.Config.ARGB_8888);
    ...
    private Path circleDrawablePath(Path path) {
        ...
        path.addCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), radius, Path.Direction.CW);
        return path;
    }
    ...
    private Path circleBorderPath(Path path) {
        ...
        path.addCircle(mBorderRect.centerX(), mBorderRect.centerY(), radius, Path.Direction.CW);
        return path;
    }
    ...
    private Path rectDrawablePath(Path path) {
        path.addRoundRect(mDrawableRect, mAttrs.getRadiis(), Path.Direction.CW);
        return path;
    }
    ...
    private Path rectBorderPath(Path path) {
        path.addRoundRect(mBorderRect, mAttrs.getRadiis(), Path.Direction.CW);
        return path;
    }

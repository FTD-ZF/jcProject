...
public class TravelSecondAdapter extends BaseAdapter {
    ...
    public TravelSecondAdapter(Context context, TravelBsEntry bodyinfo, RequestQueue queue){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final TravelBsEntry.ListBean.HotRecBean contentinfo=mBodyInfo.getList().getHot_rec().get(position);

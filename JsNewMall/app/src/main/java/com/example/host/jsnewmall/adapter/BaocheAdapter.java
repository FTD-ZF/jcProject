...
//    private int[] arrImages = new int[]{R.mipmap.icon_baoche_a,R.mipmap.icon_baoche_b,R.mipmap.icon_baoche_c,
//            R.mipmap.icon_baoche_d, R.mipmap.icon_baoche_e,R.mipmap.icon_baoche_f,R.mipmap.icon_baoche_g,R.mipmap.icon_baoche_h};

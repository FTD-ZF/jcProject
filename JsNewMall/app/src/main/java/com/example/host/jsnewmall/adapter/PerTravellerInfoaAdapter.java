...
import com.example.host.jsnewmall.activity.PerTravellerInfoActivity;
...
public class PerTravellerInfoaAdapter extends BaseAdapter {
    ...
    private List<OrderdetailsEntry.OrdercontactBean> mBodyList;
    public PerTravellerInfoaAdapter(Context context, List<OrderdetailsEntry.OrdercontactBean> list){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        OrderdetailsEntry.OrdercontactBean bodyinfo=mBodyList.get(position);
        Holder holder;
        if (convertView == null) {
            holder = new Holder();
            ...
            holder.mLine=(LinearLayout)convertView.findViewById(R.id.ln_pertraveller_line);//线

...
public class TicketFirstAdapter extends BaseAdapter{


    private Context mContext;

    private int[] arrImages = new int[]{R.mipmap.icon_ticket_a,R.mipmap.icon_ticket_b,R.mipmap.icon_ticket_c,R.mipmap.icon_ticket_d
            ,R.mipmap.icon_ticket_e,R.mipmap.icon_ticket_f,R.mipmap.icon_ticket_g};

    private RequestQueue queue;
    private ImageLoader imageLoader;
    public TicketFirstAdapter(Context context, RequestQueue queue){

...
public class SearchHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_activity_search_second, null);


            holder.tv = (TextView) convertView.findViewById(R.id.tv_item_search_history);
            //设置标题

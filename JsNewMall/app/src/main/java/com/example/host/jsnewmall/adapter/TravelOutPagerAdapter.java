...
public class TravelOutPagerAdapter extends PagerAdapter {

    private Context mContext;
    private ImageLoader imageLoader;
    private RequestQueue queue;
    private TravelOutEntry mBodyinfo;
    public TravelOutPagerAdapter(Context context, RequestQueue queue, TravelOutEntry bodyinfo) {
        super();
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        final TravelOutEntry.ListBean.BannerBean bannerInfo = mBodyinfo.getList().getBanner().get(position

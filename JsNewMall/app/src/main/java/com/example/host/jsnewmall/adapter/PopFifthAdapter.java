...
/**
 * Created by host on 2017/4/5.
 */

public class PopFifthAdapter  extends BaseAdapter {

    private SearchkeywordEntry mBodyinfo;
    private Context mContext;
    private int mSelect=0;

    public PopFifthAdapter(Context context, SearchkeywordEntry info) {
        this.mBodyinfo = info;
    ...
    @Override
    public int getCount() {
        return mBodyinfo.getBacktrafficdata().size();
    }

    @Override
    public Object getItem(int position) {
        return mBodyinfo.getBacktrafficdata().get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        holder.tvname.setText(mBodyinfo.getBacktrafficdata().get(position).getAttrdetailname());

...
public class TravelOutSecondAdapter extends BaseAdapter {
    ...
    public TravelOutSecondAdapter(Context context, TravelOutEntry bodyinfo, RequestQueue queue){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final TravelOutEntry.ListBean.HotRecBean contentinfo=mBodyinfo.getList().getHot_rec().get(position);

...
public class TravelThirdAdapter extends BaseAdapter {
    ...
    private TravelBsEntry mbodyinfo;
    private RequestQueue queue;

    private ImageLoader imageLoader;
    public TravelThirdAdapter(Context context, TravelBsEntry bodyinfo, RequestQueue queue){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        final TravelBsEntry.ListBean.LindesListBean contentinfo=mbodyinfo.getList().getLindes_list().get(position);
        Holder holder;
        if (convertView == null) {
            holder = new Holder();

...
public class TicketFirstFragment extends BaseFragment {
    ...
    private void initView(){
        ...
        mNetImageFirst.setBackground(getActivity().getResources().getDrawable(R.mipmap.icon_ticket_banner));

        mTvFirstContent.setText("\u3000\u3000"+getActivity().getResources().getString(R.string.ticket_a_a));
        mFirstListView=(ListView) view.findViewById(R.id.list_hotel_view);  //图片显示列表
        mFirstListView.addHeaderView(headerView);

        TicketFirstAdapter mFirstAdapter=new TicketFirstAdapter(getActivity(),queue);

...
public class AllOrderActivity extends BaseActivity {
    ...
    private void initView(){
        ...
        mTvordera.setTextColor(getResources().getColor(R.color.title_orange));
            ...
            mTvorderb.setTextColor(getResources().getColor(R.color.title_orange));
        }else if (currentpage==2){
            mPager.setCurrentItem(2);// 设置当前显示标签页为第一页
            mTvorderc.setTextColor(getResources().getColor(R.color.title_orange));
        }else if (currentpage==3){
            mPager.setCurrentItem(3);// 设置当前显示标签页为第一页
            mTvorderd.setTextColor(getResources().getColor(R.color.title_orange));
        }

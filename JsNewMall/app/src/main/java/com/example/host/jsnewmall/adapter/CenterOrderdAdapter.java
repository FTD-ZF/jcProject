...
import com.example.host.jsnewmall.model.CenterOrderdEntry;
...
public class CenterOrderdAdapter extends BaseAdapter {
    private List<CenterOrderdEntry.OrderlistBean> mBodyInfoList;
    private Context mContext;

    public CenterOrderdAdapter(Context context, List<CenterOrderdEntry.OrderlistBean> mlist) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
         ...
         *@"8":@"待出游"};
         */
        final CenterOrderdEntry.OrderlistBean mBodyInfo = mBodyInfoList.get(position);
        String orderstate = mBodyInfo.getOrder_state();//订单状态
        Holder holder;
        if (convertView == null) {
            holder = new Holder();
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_center_order_d_view, null);
            holder.mOrdera = (TextView) convertView.findViewById(R.id.tv_order_d_a);//订单号
            holder.mOrderb = (TextView) convertView.findViewById(R.id.tv_order_d_b);//订单名字
            holder.mOrderc = (TextView) convertView.findViewById(R.id.tv_order_d_c);//出发日期显示
            holder.mOrderd = (TextView) convertView.findViewById(R.id.tv_order_d_d);//金额显示
            holder.mOrdere = (TextView) convertView.findViewById(R.id.tv_order_d_e);//付款状态显示
            holder.mOrderf = (TextView) convertView.findViewById(R.id.tv_order_d_f);//查看详情按钮
            holder.mOrderg = (TextView) convertView.findViewById(R.id.tv_order_d_g);//立即付款按钮显示与否
            holder.mcrqty = (TextView) convertView.findViewById(R.id.tv_crqtyd);//成人
            holder.mrtqty = (TextView) convertView.findViewById(R.id.tv_rtqtyd);//儿童
            holder.mlrqty = (TextView) convertView.findViewById(R.id.tv_lrqtyd);//老人
            holder.mxsqty = (TextView) convertView.findViewById(R.id.tv_xsqtyd);//学生

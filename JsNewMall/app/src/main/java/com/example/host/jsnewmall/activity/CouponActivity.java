...
public class CouponActivity extends BaseActivity {
    ...
    private List<CouponEntry.DataBean> mBodyListaa;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case FINISH_CODE:
                    ...
                    mBodyListaa.addAll(mList);
                    if (adapter==null) {
                        adapter=new CouponAdapter(getApplicationContext(),mBodyListaa);
...
//        mImgBack.setImageDrawable(getApplicationContext().getResources().getDrawable(R.mipmap.backicon_a));
    ...
    private void initData(){
        ...
        try {
            ...
            jbody.put("is_page",1);//是否分页,1是，2否

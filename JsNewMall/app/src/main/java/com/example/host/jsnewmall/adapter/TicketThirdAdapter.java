...
public class TicketThirdAdapter extends BaseAdapter {


    private Context mContext;

    private int[] arrImages = new int[]{R.mipmap.icon_ticket_third_a, R.mipmap.icon_ticket_third_b, R.mipmap.icon_ticket_third_c,
            R.mipmap.icon_ticket_third_d, R.mipmap.icon_ticket_third_e};

    private RequestQueue queue;
    private ImageLoader imageLoader;

    public TicketThirdAdapter(Context context, RequestQueue queue) {

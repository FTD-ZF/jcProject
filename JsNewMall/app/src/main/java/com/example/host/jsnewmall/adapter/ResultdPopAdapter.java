...
public class ResultdPopAdapter extends BaseAdapter {
    private Context mContext;
    private List<ResultdInfo> mdata;
    private int selectItem = -1;

    public ResultdPopAdapter(Context context,List<ResultdInfo> data) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_searchresult_b, null);
            viewHolder.tv1 = (TextView) view.findViewById(R.id.tv_searchresult_item_b);

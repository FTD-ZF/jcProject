...
import com.example.host.jsnewmall.adapter.CenterOrderbAdapter;
...
public class CenterOrderbFragment extends BaseFragment {
    ...
    private CenterOrderbEntry mOrderaInfo;
    private PullableListView mListview;
    private int currentpage=1;
    private CenterOrderbAdapter adaptera;
    private List<CenterOrderbEntry.OrderlistBean> mBodyListaa;
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case FINISH_CODE:
                    dialog.dismiss();
                    List<CenterOrderbEntry.OrderlistBean> mBodyList = mOrderaInfo.getOrderlist();
                    ...
                    if (adaptera==null) {
                        adaptera = new CenterOrderbAdapter(getActivity(), mBodyListaa);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mBodyListaa = new ArrayList<CenterOrderbEntry.OrderlistBean>();
    ...
    private void initView(){
        mPullLayout=(PullToRefreshLayout)view.findViewById(R.id.refresh_view_orderb);//布局刷新监听
        mListview=(PullableListView)view.findViewById(R.id.content_view_b);//listview
    }
    ...
    protected  void dohttpOrderaInfo(String url,JSONObject  paramhash){
        HttpUtils.dopost(url,getActivity(),paramhash, new HttpUtils.CallBack() {
            ...
            public void onRequestComplete(String result) {
                ...
                mOrderaInfo=gson.fromJson(body, CenterOrderbEntry.class);

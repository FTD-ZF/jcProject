...
public class SharedPreferencesUtils {
     ...
     * @return
     */
    public static boolean savecity(Context context,String info){
        SharedPreferences pref =context.getSharedPreferences("city",0);
        return pref.edit().putString("city",info).commit();
    }
    ...
    public static boolean savecityid(Context context,int info){
        SharedPreferences pref =context.getSharedPreferences("cityid",0);
        return pref.edit().putInt("cityid",info).commit();
    }


    public static int getCityid(Context context){
        SharedPreferences pref=context.getSharedPreferences("cityid",0);
        return pref.getInt("cityid",0);
    }

...
public class CountryThirdAdapter extends BaseAdapter {
    ...
    public CountryThirdAdapter(Context context, TravelCountryEntry bodyinfo, RequestQueue queue) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        final TravelCountryEntry.ListBean.LindesListBean contentinfo = mbodyinfo.getList().getLindes_list().get(position);
        Holder holder;
        if (convertView == null) {
            holder = new Holder();
